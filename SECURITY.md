...
- v44 Trust Center exposes the visible browser-side security posture inside the product, including CSP shape, inline-handler checks, source URL trust, import limits, local storage footprint, and release-shape readiness.
